...
#include "Actor/Include/Socket/UnrealSocketIsar.h"

//Destructor, free memory
UnrealSocketIsar::~UnrealSocketIsar()
{
	if (ConnectionSocket){
...
int UnrealSocketIsar::SendBytes(const void* Buffer, int32 N)
{
...
int UnrealSocketIsar::SendObsBytes(const void* Buffer, int32 N)
{
	const uint8* Data = static_cast<const uint8*>(Buffer);
...
bool UnrealSocketIsar::StartTCPReceiver(const int32 SocketPort)
{
...
FSocket* UnrealSocketIsar::CreateTCPConnectionListener(const FString& SocketName, const int32 ReceiveBufferSize)
{
...
bool UnrealSocketIsar::TCPConnectionListener()
{
	bool Check = false;
...
void UnrealSocketIsar::CloseConnectionSocket()
{
...
void UnrealSocketIsar::CloseListenerSocket()
{
...
const FString UnrealSocketIsar::TCPSocketListener()
{
	//~~~~~~~~~~~~~
...
bool UnrealSocketIsar::FormatIP4ToNumber(uint8(&Out)[4])
{
	//IP Formatting
...
FString UnrealSocketIsar::StringFromBinaryArray(const TArray<uint8>& BinaryArray)
{
